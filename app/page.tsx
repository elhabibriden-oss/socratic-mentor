...
  // Chat Sessions & Persistence State
...
  return (
    <div className="flex h-screen bg-[#FDFBF7] text-[#2C2A29] font-sans antialiased overflow-hidden selection:bg-[#D97706] selection:text-white">
      {/* ================= SIDEBAR ================= */}
      <aside
        className={`${
          sidebarOpen ? 'w-72' : 'w-0 -translate-x-full'
        } transition-all duration-300 ease-in-out bg-[#F7F4EE] border-r border-[#EBE5DA] flex flex-col z-30 shrink-0 overflow-hidden shadow-sm`}
      >
        {/* Brand Header */}
...
              <div
                key={session.id}
                onClick={() => { setActiveId(session.id); setActivePage('chat'); }}
...
      <main className="flex-1 flex flex-col h-full bg-[#FDFBF7] relative overflow-hidden">
        {/* Top Navbar */}
...
              <span className="text-xs font-semibold text-[#3C3633] tracking-tight font-serif uppercase">
...
                  {/* Hero Image */}
                  <div className="relative w-full h-48 rounded-2xl overflow-hidden shadow-md border border-[#EBE5DA] group">
                    <img 
...
                      <h2 className="text-lg font-serif font-medium text-white tracking-tight">Deconstruct Reality from First Principles</h2>
                    </div>
                  </div>
...
            {/* Input Control Area */}
            <div className="p-4 md:p-6 bg-[#FDFBF7] border-t border-[#EBE5DA] shrink-0">
...
                  className="w-full bg-[#F7F4EE] border border-[#EBE5DA] focus:border-[#D97706] focus:ring-1 focus:ring-[#D97706] rounded-2xl py-4 pl-5 pr-14 text-sm text-[#2C2A29] placeholder-[#A89F96] outline-none transition shadow-2xs"
                />
                <button
                  type="submit"
                  disabled={loading || !input.trim()}
                  className="absolute right-3 bg-[#D97706] hover:bg-[#B45309] disabled:opacity-30 text-white p-2.5 rounded-xl transition shadow-xs flex items-center justify-center cursor-pointer disabled:cursor-not-allowed"
                >
